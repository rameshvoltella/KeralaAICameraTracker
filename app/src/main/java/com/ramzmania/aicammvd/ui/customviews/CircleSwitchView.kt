...
import androidx.compose.ui.unit.dp
@Composable
fun CustomCircleSwitch(outerCircleSize: Dp, innerCircleSize: Dp, outerColor:Color, innerColor:Color) {
...
//    CustomCircle(outerCircleSize = 200.dp, innerCircleSize = 100.dp, spaceBetween = 60.dp)
    ...
    CustomCircleSwitch(outerCircleSize = 300.dp, innerCircleSize = 250.dp,Color.Red, Color.Blue)
}