...
private val contextModule: ContextModule
    ...
    override suspend fun requestCameraLocation(): Resource<CameraData> {
        val jsonFileName = "your_json_file.json" // Replace with the name of your JSON file
